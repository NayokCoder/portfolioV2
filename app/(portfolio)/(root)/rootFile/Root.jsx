...
const Root = () => {
  ...
  return (
    <>
      <div className="hidden xl:flex h-full w-full gap-3 lg:gap-5 flex-col lg:flex-row-reverse rounded-xl lg:rounded-2xl p-4 lg:p-0">
        <MenuNav nav={navItems} scrollContainerRef={parentRef} className="hidden lg:flex" />

        <div className="grow h-full overflow-hidden 0">
          <content className=" ">
            <ScrollArea className="h-full lg:pe-5 lg:-me-5  max-w-5xl mx-auto" viewportRef={parentRef}>
