  ...
  return (
    <div className={cn("mx-auto max-w-sm  antialiased md:max-w-4xl mt-4", className)}>
      <div className="relative grid grid-cols-1 gap-20 ">
        <div className="flex flex-col w-full  justify-between py-4">
          ...
          >
            ...
            <motion.p className="mt-8 text-xl md:text-2xl lg:text-3xl xl:text-4xl text-gray-500 dark:text-neutral-300">
              "
      ...
      <div className="flex justify-end px-6">
        <div className="relative w-40 h-52 md:h-72 md:w-60 py-10">
          <AnimatePresence>
