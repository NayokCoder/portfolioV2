...
const { default: Contact } = require("@/app/(portfolio)/(root)/contact/Contact");
const { default: Course } = require("@/app/(portfolio)/(root)/courses/Course");
const { default: Intro } = require("@/app/(portfolio)/(root)/introduction/Intro");
const { default: Project } = require("@/app/(portfolio)/(root)/projects/Project");
