  ...
  return (
    <div>
      <div className="flex px-6 group">
        <button className={`${params[0].width} ${params[0].minWidth} flex items-center justify-between rounded-full ${params[1].bgColour} p-2 text-foreground group-hover:text-chart-1 `}>
